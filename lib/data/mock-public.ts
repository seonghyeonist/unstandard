import type { Candidate, PublicProfile } from "@/types/profile";
...
/** Public card data only — no private letters in this module. */
export const publicProfiles: PublicProfile[] = candidates.map((candidate) => ({
  ...candidate,
  locked: {
