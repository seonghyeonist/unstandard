  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p className="mt-3">본인인증 연동 준비 대상은 Didit V3 hosted KYC입니다. 현재 활성 수탁자로 추가했다는 뜻은 아닙니다. 실제 계약 당사자·처리 항목·보유기간·국외 이전 여부와 인증사 문의 경로를 확정해 고지하고, 로그 잔존 방지를 점검하기 전에는 본인인증을 활성화하지 않습니다. 인증사의 보관분까지 ‘확인 즉시 폐기’한다고 약속하지 않습니다.</p>
      </>
    ),
  },
  {
