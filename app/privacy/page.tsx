...
const sections = [
  ...
  },
  {
    ...
    body: (
      <>
        <p>서비스 제공을 위해 아래 수탁자가 정보를 처리합니다. 광고 판매나 제3자 마케팅 제공은 하지 않습니다.</p>
        <ul className="mt-3 list-disc space-y-2 pl-5">
          <li>Vercel: 웹 호스팅·전송·운영 로그, 미국 등 글로벌 인프라, 서비스 이용 시 네트워크로 이전, 계정 삭제 또는 계약상 보유기간까지</li>
          <li>Neon: 계정과 서비스 데이터베이스, 미국 AWS us-east-2(Ohio), 서비스 이용 시 네트워크로 이전, 계정 삭제 및 최대 6시간 복구 이력 만료까지</li>
        </ul>
      </>
    ),
  },
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p className="mt-3"><strong>개인정보 보호책임자 및 고충처리 담당:</strong> Founder · seonghyeonist</p>
        <p className="mt-1"><strong>접수 채널:</strong> 앱 설정 → 지원·안전 요청 (개인정보 분류)</p>
      </>
    ),
  },
];
  ...
  return (
    <main className="mx-auto min-h-dvh max-w-2xl px-5 py-8">
      ...
      <div className="mt-10 space-y-9 text-sm leading-7 text-foreground/75">
        ...
        <section>
          <h2 className="text-xl font-black tracking-[-0.03em] text-foreground">6. 관련 기준</h2>
          <p className="mt-3">
            이 안내는 개인정보보호위원회의 최신 처리방침 작성지침과 개인정보 보호법 제30조를 기준으로 작성했습니다.
          </p>
          <div className="mt-3 flex flex-col gap-2">
            <a className="underline underline-offset-4" href="https://www.pipc.go.kr/np/cop/bbs/selectBoardArticle.do?bbsId=BS217&mCode=&nttId=12018" rel="noreferrer" target="_blank">개인정보보호위원회 2026 처리방침 작성지침</a>
