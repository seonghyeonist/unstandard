    ...
    body: (
      <>
        ...
        <ul className="mt-3 list-disc space-y-2 pl-5">
          ...
          <li>실명·전화번호 원문: 현재 미수집. 향후 인증사 전용 입력 화면을 연결하고, 언스탠다드 회원 DB·애플리케이션 로그에 원문을 저장하지 않는 방식으로 검토합니다. 인증사 자신의 보관·파기 의무까지 확인 즉시 폐기된다고 고지하지 않으며, 실제 수탁자와 처리조건을 확정·고지하기 전에는 활성화하지 않습니다.</li>
